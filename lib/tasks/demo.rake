...
@@all_models = [:sites, :users, :protocols, :patients, :cohorts, :cohort_assignments, :lab_tests, :patient_evaluations, :samples, :experiments, :data_files, :task_statuses, :task_categories, :task_priorities, :tasks]
